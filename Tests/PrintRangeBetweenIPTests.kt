...
class PrintRangeBetweenIPTests {
    ...
    private val ip3 = AddressIP(mutableListOf(100, 200, 30, 5))
    private val ip4 = AddressIP(mutableListOf(100, 255, 255, 255))
    private val ip5 = AddressIP(mutableListOf(101, 0, 0, 1))
